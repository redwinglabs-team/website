        ...
        <Container>
          <Routes >
            ...
            <Route
              exact
              path={ROUTE_PRODUCTS}
              element={<ProductsQuadroSuiteContainer/>}
            />
            <Route
              exact
              path={ROUTE_PRODUCTS_QUADRO_SUITE}
              element={<ProductsQuadroSuiteContainer/>}
            />
            <Route
              exact
              path={ROUTE_PRODUCTS_QUADRO_PMS}
              element={<ProductsQuadroPmsContainer/>}
            />
            <Route
              exact
              path={ROUTE_PRODUCTS_QUADRO_FNB}
              element={<ProductsQuadroFnbContainer/>}
            />
            <Route
              exact
              path={ROUTE_PRODUCTS_QUADRO_POP}
              element={<ProductsQuadroPopContainer/>}
            />
            <Route
              exact
              path={ROUTE_PRODUCTS_QUADRO_ENTERTAINMENT}
              element={<ProductsQuadroEntertainmentContainer/>}
            />
